...
make_group(group2_i_b,
	inv, inv, inv, inv, 
	shl_rm_imm_b, shl_rm_imm_b, inv, shl_rm_imm_b)

/* 0xc1 */
make_group(group2_i_v,
	inv, inv, inv, inv, 
	shl_rm_imm_v, shl_rm_imm_v, inv, shl_rm_imm_v)

/* 0xd0 */
make_group(group2_1_b,
	inv, inv, inv, inv, 
	shl_rm_1_b, shl_rm_1_b, inv, shl_rm_1_b)

/* 0xd1 */
make_group(group2_1_v,
	inv, inv, inv, inv, 
	shl_rm_1_v, shl_rm_1_v, inv, shl_rm_1_v)

/* 0xd2 */
make_group(group2_cl_b,
	inv, inv, inv, inv, 
	shl_rm_cl_b, shl_rm_cl_b, inv, shl_rm_cl_b)

/* 0xd3 */
make_group(group2_cl_v,
	inv, inv, inv, inv, 
	shl_rm_cl_v, shl_rm_cl_v, inv, shl_rm_cl_v)
...
/* 0xc0 */	group2_i_b, group2_i_v, ret_c2, ret_c3,
...
/* 0xb4 */	inv, inv, movzx_rmb2r_v, movzx_rmw2r, 
/* 0xb8 */	inv, inv, inv, inv,
/* 0xbc */	inv, inv, movsx_rmb2r_v, movsx_rmw2r,
